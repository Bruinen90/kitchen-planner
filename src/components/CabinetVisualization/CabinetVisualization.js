...
import InteriorVisualization from '../InteriorVisualization/InteriorVisualization';
import kitchenSinkIcon from '../../img/devices/kitchen_sink_icon.png';
import hobIcon from '../../img/devices/hob_icon.png';
import './CabinetVisualization.css';

class CabinetVisualization extends Component {
  render() {
