...
import './InteriorVisualization.css';
import {connect} from 'react-redux';
import dishwasherIcon from '../../img/devices/dishwasher_icon.png';

class InteriorVisualization extends Component {
    render() {
...
export default connect(mapStateToProps)(InteriorVisualization);
