...
const Instrukcja = () => {
    return(
        <div className="instrukcja">
            ...
            <li> Po naciśnięciu przycisku ENTER pod wizualizacją kuchni w sekcji "Wymiary formatek do zamówienia" pojawi się pierwszy element - blat. Jego szerokość będzie mniejsza o 3 mm niż zmieżona przez Ciebie szerokość kuchni. Wynika to z konieczności wprowadzenie luzu pozawalajacego na komfortoway montaż blatu. Nie przejmuj się - powstała w ten sposób szpara zniknie pod płytkami/lacobelem, którzych grubość  wynosi co najmniej 8 mm na stronę. </li>
            <li> </li>
            <li> </li>
